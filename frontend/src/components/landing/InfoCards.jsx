          ...
          {cards.map((card, index) => (
            <div key={index} className="group overflow-hidden rounded-2xl bg-white shadow-xl transform transition hover:-translate-y-2">
              <div className="relative h-64 overflow-hidden">
                <div className="absolute inset-0 bg-blue-900/10 group-hover:bg-transparent transition duration-300 z-10" />
                <img
                  src={card.image}
                  alt={card.title}
              ...
              <div className="p-8 space-y-4">
                <h3 className="text-2xl font-bold text-blue-900">{card.title}</h3>
        ...
        >
          ...
          >
            <div className="p-6 border-b border-gray-100 flex justify-between items-center">
              <h3 className="text-2xl font-bold text-blue-900">{activeCard.title}</h3>
            ...
            <div className="p-6 bg-gray-50 text-right rounded-b-2xl">
              <button 
                onClick={() => setActiveCard(null)}
                className="px-8 py-2 bg-blue-900 text-white font-bold rounded-lg hover:bg-blue-800 transition shadow-lg"
              >
                Close
              </button>
            </div>
